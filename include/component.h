...
class component
{
    public:
         ...
         * @{
         */
        static constexpr float YEAR = 365. * 24;    ///< hours of one year
        static constexpr float kB = 8.6173303E-5;   ///< Boltzmann constant
        static constexpr float KELVIN = 273.15;     ///< convert Celsius into Kelvin
        ///@}
